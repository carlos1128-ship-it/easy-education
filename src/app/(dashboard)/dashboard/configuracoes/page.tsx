...
export default async function ConfiguracoesPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <div>
        <p className="text-sm font-semibold text-[#4F46E5]">Configuracoes</p>
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-[#0F172A]">Preferencias da conta</h1>
      </div>
        ...
        <section className="rounded-[20px] border border-[#E2E8F0] bg-white p-6 shadow-sm">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[#64748B]">Dados usados pela IA para personalizar planos, quizzes e revisoes.</p>
            </div>
          </div>
        ...
        <aside className="space-y-4">
          <section className="rounded-[20px] border border-[#E2E8F0] bg-white p-5 shadow-sm">
            <div className="mb-3 flex items-center gap-3">
              ...
              <h2 className="font-bold text-[#0F172A]">Seguranca</h2>
            </div>
            <p className="text-sm text-[#64748B]">Sessao protegida. Use sair no menu para encerrar neste dispositivo.</p>
          </section>
        </aside>
      </div>
    </div>
